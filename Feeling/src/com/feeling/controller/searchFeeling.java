...
public class searchFeeling extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public searchFeeling() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Feeling feeling=fs.searchFeeling(id);
		
		request.setAttribute("feeling", feeling);
		request.getRequestDispatcher("myFeeling.jsp").forward(request, response);
