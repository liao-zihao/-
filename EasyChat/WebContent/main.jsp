...
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临神之低语，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
	...
	function showContent(){
		$.post("${pageContext.request.contextPath}/user?"+new Date().getTime(),{'method':'getMessage'},function(data){
			$("#content").html(sysBBS+data);//实时刷新重写全部
		});
	}
		...
		<form action="" id="form1" name="form1" method="post">
			...
			<tr>
				...
				<td colspan="2" align="center" class="word_dark">&nbsp;All
					CopyRights reserved 莫问科技有限公司</td>
				<td align="center">&nbsp;</td>
			</tr>
		</form>
	</table>
